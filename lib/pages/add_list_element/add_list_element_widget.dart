...
class AddListElementWidget extends StatefulWidget {
  const AddListElementWidget({super.key});

  @override
  State<AddListElementWidget> createState() => _AddListElementWidgetState();
}

class _AddListElementWidgetState extends State<AddListElementWidget> {
  late AddListElementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddListElementModel());
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: FFLocalizations.of(context).getText(
                        '45up6wgs' /* Enter the description here. */,
                      ),
                      labelStyle:
                          FlutterFlowTheme.of(context).labelLarge.override(
                                fontFamily: 'Readex Pro',
                    ...
                    cursorColor: FlutterFlowTheme.of(context).primary,
                    validator:
                        _model.detailsControllerValidator.asValidator(context),
                  ),
                ),
              ),
              FFButtonWidget(
