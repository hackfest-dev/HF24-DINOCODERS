...
import 'edit_profile_p_model.dart';
export 'edit_profile_p_model.dart';

class EditProfilePWidget extends StatefulWidget {
  const EditProfilePWidget({
    super.key,
    String? title,
  ...
  @override
  State<EditProfilePWidget> createState() => _EditProfilePWidgetState();
}

class _EditProfilePWidgetState extends State<EditProfilePWidget> {
  late EditProfilePModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditProfilePModel());
          ...
          Padding(
            ...
            child: Text(
              FFLocalizations.of(context).getText(
                'eigygzk9' /* Adjust the content below to up... */,
              ),
