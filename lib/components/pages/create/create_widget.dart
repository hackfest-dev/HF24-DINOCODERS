                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'o2bujler' /* Create an account by using the... */,
                                ),
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                ...
                                text: FFLocalizations.of(context).getText(
                                  '3t6mfevu' /* Continue with Phone Number */,
                                ),
                                icon: const Icon(
                                  Icons.phone,
                                  size: 20.0,
                                      ...
                                      children: [
                                        TextSpan(
                                          text: FFLocalizations.of(context)
                                              .getText(
                                            '1cqkiwom' /* Already have an account?  */,
                                          ),
