...
import 'edit_profile_c_model.dart';
export 'edit_profile_c_model.dart';

class EditProfileCWidget extends StatefulWidget {
  const EditProfileCWidget({
    super.key,
    String? title,
  ...
  @override
  State<EditProfileCWidget> createState() => _EditProfileCWidgetState();
}

class _EditProfileCWidgetState extends State<EditProfileCWidget> {
  late EditProfileCModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditProfileCModel());
          ...
          Padding(
            ...
            child: Text(
              FFLocalizations.of(context).getText(
                'hsqjv1rn' /* Adjust the content below to up... */,
              ),
